...
@Component({
  standalone: true,
  selector: 'app-tenant-categorias-insumo-list',
  ...
  templateUrl: './categorias-insumo-list.component.html',
  styleUrls: ['./categorias-insumo-list.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TenantCategoriasInsumoListComponent implements OnDestroy {
  ...
  data = signal<CategoriaInsumoDto[]>([]);
  total = signal(0);
  pageIndex = signal(0);
  pageSize = signal(10);
  ...
  edit(e: CategoriaInsumoDto) {
    this.router.navigate(['/tenant/categorias-insumo/cadastro'], { state: { id: e.id } });
  }

  view(e: CategoriaInsumoDto) {
    this.router.navigate(['/tenant/categorias-insumo/cadastro'], { state: { id: e.id, view: true } });
  }
