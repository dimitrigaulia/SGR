...
@Component({
  standalone: true,
  selector: 'app-tenant-perfis-list',
...
export class TenantPerfisListComponent implements OnDestroy {
  ...
  edit(e: TenantPerfilDto) {
    this.router.navigate(['/tenant/perfis/cadastro'], { state: { id: e.id } });
  }

  view(e: TenantPerfilDto) {
    this.router.navigate(['/tenant/perfis/cadastro'], { state: { id: e.id, view: true } });
  }
