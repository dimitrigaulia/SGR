...
export class PerfisListComponent implements OnDestroy {
  ...
  edit(e: PerfilDto) { this.router.navigate(['/backoffice/perfis/cadastro'], { state: { id: e.id } }); }
  view(e: PerfilDto) { this.router.navigate(['/backoffice/perfis/cadastro'], { state: { id: e.id, view: true } }); }
